...
export const step1Schemas: FormSchema[] = [
  ...
  createFormSchema('noLoadCurrent', '空载电流', '60%', 3, 6),
...
export const step2Schemas: FormSchema[] = [
  ...
  createFormSchema('phaseAChange', 'A相短路阻抗变化量', '60%', 3, 6),
  createFormSchema('phaseBChange', 'B相短路阻抗变化量', '60%', 3, 6),
  createFormSchema('phaseCChange', 'C相短路阻抗变化量', '60%', 3, 6),
  createFormSchema('threePhaseRactanceMaxDiff', '三相电抗最大差值', '60%', 3, 6),
  createFormSchema('loadLossChange', '空载损耗变化量', '60%', 2, 6),
  createFormSchema('noLoadLossChange', '负载损耗变化量', '60%', 3, 6),
