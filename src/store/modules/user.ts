...
import { PowGetUserInfoModel, LoginParams } from '/@/api/sys/model/userModel';
...
export const useUserStore = defineStore({
  ...
  actions: {
    ...
    ): Promise<PowGetUserInfoModel | null> {
      try {
    ...
    async afterLoginAction(goHome?: boolean): Promise<PowGetUserInfoModel | null> {
