export interface DecisionEvaluate {
  input: DecisionEvaluateInput;
  output: DecisionEvaluateOutput;
  [property: string]: any;
}
...
export interface DecisionEvaluateOutput {
  evaluateId: number;
  /**
   * 检修内容
   */
...
export interface EconomyEvaluate {
  input: EconomyEvaluateInput;
  output: EconomyEvaluateOutput;
  [property: string]: any;
}

export interface EconomyEvaluateInput {
  /**
   * 年平均故障次数
   */
...
export interface EconomyEvaluateOutput {
  /**
   * 年均成本
   */
...
export interface ReliabilityEvaluate {
  input: ReliabilityEvaluateInput;
  output: ReliabilityEvaluateOutput;
  [property: string]: any;
}
...
export interface ReliabilityEvaluateOutput {
  /**
   * 测试Id
   */
  evaluateId: number;
...
export interface StateEvaluate {
  input: StateEvaluateInput;
  output: StateEvaluateOutput;
  [property: string]: any;
}

export interface StateEvaluateInput {
  /**
   * 吸收比，高中低依次存储
   */
...
export interface StateEvaluateOutput {
  /**
   * 油中溶解气体劣化度信息
   */
  deterFactor1: number;
